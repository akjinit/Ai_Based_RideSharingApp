            ...
            <div className="mb-4">
              ...
              <div className="flex gap-4">
                <input
                  ...
                  className="bg-slate-800/50 border border-slate-700 w-1/2 text-sm placeholder:text-gray-500 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all text-white"
